  ...
  <div>
    ...
    <ul>
      ...
      <li v-for="(todo, index) in todos" :key="index">
        ...
        <input type="text"  :style="{ textDecoration: todo.isDone ? 'line-through' : 'none' }" v-model="todo.name" :readonly="!todo.isEdit">
        <!-- 編集ボタンコンポーネント：index と todos 配列を props として渡す -->
        <EditButton7 :id="index" :todos="todos"/> 
